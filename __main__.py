from bot_blocker.bad_bot_blocker import *
import configparser
import logging
...
def read_config(file_path: str = 'config.ini'):
...
def get_parameters(config):
    try:
        ...
        return {"log_file_name": log_file_name, "log_file_location": log_file_location, "log_file_format": log_file_format, "timestamp_format": timestamp_format, "good_domain_list": good_domain_list, "interval_one": interval_one, "interval_two": interval_two, "frequency_one": frequency_one, "frequency_two": frequency_two}
